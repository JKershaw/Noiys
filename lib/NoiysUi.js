var NoiysUi = function() {
		...
		// function generate_status_as_parent_html(status) {

		// 	var icon_row = generate_icon_row_html(status, true);


		// 	var status_as_parent_html = " \
		// 		 <li class=\"list-group-item list-status\">" + status.html + "</li> \
		// 			" + icon_row + " \
		// 		";

		// 	return status_as_parent_html;
		// }
		...
		return {
			...
			//generate_status_as_parent_html: generate_status_as_parent_html
		}
	}
